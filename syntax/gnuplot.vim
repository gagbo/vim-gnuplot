" Vim syntax file
" Language:     gnuplot 5.x.x
" Maintainer:   Gerry Agbobada <gagbobada+git AT gmail DOT com>
" Last Maintainer:   Josh Wainwright <wainwright DOT ja AT gmail DOT com>
" Previous Maintainer:      Andrew Rasmussen andyras@users.sourceforge.net
" Original Maintainer:  John Hoelzel johnh51@users.sourceforge.net
" Last Change:  2017-10-11
" Filenames:    *.gnu *.plt *.gpi *.gih *.gp *.gnuplot scripts: #!*gnuplot
" URL:          http://github.com/gagbo/vim-gnuplot
" Previous URL:          http://www.vim.org/scripts/script.php?script_id=4873
